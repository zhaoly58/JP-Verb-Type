...
//    var body: some View {
//        VStack {
//                // Loop through verbs and create text fields for input
//                ForEach(verbs, id: \.baseVerb) { verb in
//                    VStack {
//                        Text(verb.baseVerb)
//                        ForEach(ConjugationType.allCases, id: \.self) { conjugation in
//                            TextField("\(conjugation.rawValue)", text: $userInputs[verb.baseVerb + conjugation.rawValue])
...
//    func checkAnswers() {
//        for verb in verbs {
//            for conjugation in ConjugationType.allCases {
//                let input = userInputs[verb.baseVerb + conjugation.rawValue]
//                let correctAnswer = verb.answers[conjugation]
//                
//                // Compare user input with the correct answer
//                if input == correctAnswer {
//                    print("\(verb.baseVerb) - \(conjugation.rawValue) is correct!")
//                } else {
//                    print("\(verb.baseVerb) - \(conjugation.rawValue) is incorrect.")
//                }
//            }
//        }
//    }
